...
<body>
<?php
$dbname = "larsondak_311"; // replace with your database name
$username = "larsondak";  // replace with your username
$password = "1024";  // replace with your password, nobody can see it
extract($_POST);
echo <<< HERE
   <form method="POST"> 
   <h2>Database: $dbname</h2>
   <h2>View Tables: 
         <input type="submit" name="button" value="users"><BR>
   </h2>
   </form>
